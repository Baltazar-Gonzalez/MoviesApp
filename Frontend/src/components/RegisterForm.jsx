...
export function RegisterForm() {
  ...
  function handleSubmit(user){
    instance.post(endpoints.postUser, {
      name: user.userName,
      email: user.email,
      image: ".",
    ...
    <Row className='' justify="center">
      ...
      <Col xs={24}>
        <Form layout='vertical' onFinish={handleSubmit}
          ...
          <Item name="userName" label="Nombre de usuario" rules={[
            {
              required: true,
          ...
          <Item name="confirmPassword" label="Repetir contraseña" rules={[
            {
              required: true,
          ...
          <Item>
            <Button className='mr-2' type="primary" htmlType="submit">Registrarse</Button>
