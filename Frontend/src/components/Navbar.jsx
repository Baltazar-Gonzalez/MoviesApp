...
const items = [
  {
    ...
    children: [
      {
        label: (
          <Link className="text-black" to="/movies/popular">
            Populares
          </Link>
        ),
        key: 'popularMovies',
      ...
      {
        label: (
          <Link className="text-black" to="/movies/cartelera">
            En carteleras
          </Link>
        ),
        key: 'nowPlaying',
      ...
      {
        label: (
          <Link className="text-black" to="/movies/proximamente">
            Proximamente
          </Link>
        ),
        key: 'onComing',
  ...
  },
  {
    ...
    children: [
      {
        label: (
          <Link className="text-black" to="/series/popular">
            Populares
          </Link>
        ),
        key: 'popularSeries',
      ...
      {
        label: (
          <Link className="text-black" to="/series/en-emision">
            En Emisión
          </Link>
        ),
        key: 'onAir',
...
export function NavBar() {
  ...
  return (
    <Flex
      className="h-16 bg-[#032541] px-4 lg:px-[0px] text-white justify-between md:justify-around"
      align="center"
    >
      ...
      <Row
        className="md:hidden min-w-[30px] p-1 text-xl rounded text-center"
      ...
      {/* Responsive Drawer */}
      <Drawer
        className="bg-[#032541] text-slate-100"
        open={open}
